...
with st.sidebar:
    ...
    ver_precios = st.toggle("💎 Ver Planes y Precios", value=False)
...
with c_badge:
    if es_pro:
        ...
        st.markdown('<div style="text-align:right"><span style="background-color:#F1F5F9; color:#64748B; padding:5px 10px; border-radius:20px; font-size:0.8em;">MODO GRATIS</span></div>', unsafe_allow_html=True)
